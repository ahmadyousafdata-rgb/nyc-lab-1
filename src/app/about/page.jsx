      ...
      <main className="bg-white">
        <Container className="pt-20 pb-16">
          ...
          <section className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 text-left">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              <h2 className="font-display text-xl font-semibold text-slate-900">Our Vision</h2>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              <h2 className="font-display text-xl font-semibold text-slate-900">Our Approach</h2>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6">
              <h2 className="font-display text-xl font-semibold text-slate-900">Industries We Automate</h2>
